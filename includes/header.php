...
<html lang="en" dir="ltr">
	<head>
		...
		<meta content="Book Publisher" name="description">
		<meta content="Book Publisher" name="author">
...
.hor-header .container, .horizontal-main .container, .hor-content .container {
    max-width: 100%;
}
}
		</style>
			...
			<div class="page-main">
					...
					<div class="app-sidebar__logo">
						<a class="header-brand" href="index.php">
							<img src="assets/images/brand/logo.png" class="header-brand-img desktop-lgo" alt="Unidemy Logo">
							<img src="assets/images/brand/logo.png" class="header-brand-img dark-logo" alt="Unidemy Logo">
					...
					<ul class="side-menu app-sidebar3">
						...
						<li class="side-item side-item-category">All Books</li>
						<li class="slide">
							...
							<span class="side-menu__label">View All Books</span><i class="angle fe fe-chevron-right"></i></a>
							<ul class="slide-menu">
								<li><a href="upload_book.php" class="slide-item">Upload Books</a></li>
						...
						<li class="slide">
							<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
								<svg xmlns="http://www.w3.org/2000/svg"  class="side-menu__icon" width="24" height="24" viewBox="0 0 24 24"><path d="M12 22c4.879 0 9-4.121 9-9s-4.121-9-9-9-9 4.121-9 9 4.121 9 9 9zm0-16c3.794 0 7 3.206 7 7s-3.206 7-7 7-7-3.206-7-7 3.206-7 7-7zm5.284-2.293 1.412-1.416 3.01 3-1.413 1.417zM5.282 2.294 6.7 3.706l-2.99 3-1.417-1.413z"/><path d="M11 9h2v5h-2zm0 6h2v2h-2z"/></svg>
							<span class="side-menu__label">All Venders</span><i class="angle fe fe-chevron-right"></i></a>
							<ul class="slide-menu">
								<li><a href="create_vender.php" class="slide-item">Create Vender</a></li>
							...
							<div class="container-fluid">
								<div class="d-flex">
									<a class="header-brand" href="index.php">
										<img src="assets/images/brand/logo.png" class="header-brand-img desktop-lgo" alt="Unidemy Logo">
										<img src="assets/images/brand/logo.png" class="header-brand-img dark-logo" alt="Unidemy Logo">
										<!-- <img src="assets/images/brand/favicon.png" class="header-brand-img mobile-logo" alt="Unidemy Logo">
										<img src="assets/images/brand/favicon1.png" class="header-brand-img darkmobile-logo" alt="Unidemy Logo"> -->
									</a>
													...
													<div class="dropdown profile-dropdown d-flex">
														...
														<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow animated">
															<div class="text-center">
																<div class="text-center user pb-0 font-weight-bold">Mahantesh</div>
