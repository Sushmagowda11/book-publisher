...
<html lang="en" dir="ltr">
	<head>
		...
		<meta content="Neet Admin Login" name="description">
		<meta content="Neet Admin Login" name="author">
										...
										<div class="col-lg-6 p-0">
											<div class="text-justified text-white p-5 register-1 overflow-hidden">
												<div class="custom-content">
													...
													<div class="ms-5">
														<div class="fs-18 mb-6 font-weight-bold text-white">Welcome Back To Unidemy Admin !</div>
										...
										<div class="bg-white text-dark br-7 br-tl-0 br-bl-0">
											<div class="card-body">
												<div class="text-center mb-3">
													<h1 class="mb-2">Unidemy</h1>
													<a href="javascript:void(0);" class="">Hello Unidemy !</a>
												</div>
												<form class="mt-5">
